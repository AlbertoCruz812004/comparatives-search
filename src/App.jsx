  ...
  return (
    <>
      <header className="py-5 px-6 flex justify-between">
        <span className="flex gap-2 items-center"><img className="w-11 p-1 bg-slate-700 rounded-full" src="./../public/white_on_black-transformed-remove.png" alt="" /> CompariSearch</span>
